...
* you have to be logged in to comment - signup/login is now ridiculous easy
...
* I get a wierd zombie comment when creating a new schedule, cant delete it either
...
* search in general
* admin area
* more JS and perhaps move to jquery
